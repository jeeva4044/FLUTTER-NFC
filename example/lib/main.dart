...
class _MyAppState extends State<MyApp> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
            backgroundColor: Color.fromARGB(255, 237, 59, 59),
            title: Center(
              child: const Text('ROOM APP'),
            ),
            bottom: TabBar(
              tabs: <Widget>[
                Tab(text: 'Read'),
          ...
          Scrollbar(
              child: SingleChildScrollView(
                ...
                flag
                    ...
                    : Text("Please Scan NFC Tag to get the link👍😁"),
                const SizedBox(height: 10),
                // Padding(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (result != null) {
                                            if (result is ndef.TextRecord) {
                                              setState(() {
                                                // _recordStrings!.add(result.toString().substring(
                                                //   result
                                                //       .toString()
                                                //       .indexOf("uri", 4)));
                                                _records!.add(result);
          ...
          onPressed: () async {
            try {
              ...
              if (tag.standard == "ISO 14443-4 (Type B)") {
                ...
                RoomNo = ndefRecords[0].toString().substring(
                    ndefRecords[0].toString().indexOf("text", 5) + 5);
                link = upiId.last.toString().substring(4);
